        ...
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG  src="http://192.168.118.168:8080/${images[0]}" jqimg="http://192.168.118.168:8080/${images[0]}" height="350" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as img>
                                <li><img src="http://192.168.118.168:8080/${img}"> </li>
                            </#list>
                        </ul>
                    </div>
            ...
            <ul>
                ...
                <li class="goods_num">
                    ...
                    <span><a class="good_num_jian" id="good_num_jian" href="javascript:void(0);"></a>
                          ...
                          <a class="good_num_jia" id="good_num_jia"  href="javascript:void(0);"></a>(当前库存0件)
                    </span>
                </li>
                <li style="padding:20px 0;">
                    <label>&nbsp;</label>
                    <span><a onclick="insertToCart()" class="goods_sub goods_sub_gou" >加入购物车</a></span>
                </li>
            </ul>
        </div>
    </div>
